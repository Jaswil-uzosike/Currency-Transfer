...
$_SESSION['amount_added'] = $conv;

if (isset ($_POST['submit'])) {
    header('Location: addpage3.php');
}
...
<form class="form" method="post">
    <fieldset>
        ...
        <div class="form-item">
            <main>
                <h6 style="font-family: laila;">
                    <?php echo "Amount Adding = " . $currfs . $ams; ?><br>
                </h6>
            </main>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <main>
                <h6 style="font-family: laila;">
                    <?php echo "Your Getting: " . $currts . $conv; ?><br>
                </h6>
            </main>
        </div>
        ...
        <br>
        <div>
            <a href="addpage1.php" class="form-button">Back</a>
        </div>
    </fieldset>
</form>