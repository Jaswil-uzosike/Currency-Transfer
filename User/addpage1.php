...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            $sql = 'SELECT currency_id FROM bank WHERE user_id = :id';
    ...
    if ($allFields == "yes") {
        $_SESSION['amount_to_add'] = $_POST['ams'];
        $_SESSION['currency_to'] = $CA;
        $_SESSION['currency_from'] = $BCAid;
        $_SESSION['currency_from_sign'] = $currfs;
        header('Location: addpage2.php');
    }
